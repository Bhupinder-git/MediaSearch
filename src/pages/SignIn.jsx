        ...
        <div className="bg-surface-card rounded-xl border border-border-subtle shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.06)] p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[14px] leading-[20px] text-text-secondary">
              Log in to your MediaSearch account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" id="signin-form">
            ...
            <div className="space-y-1.5">
              <label htmlFor="signin-email" className="block text-[13px] leading-[16px] font-medium text-text-primary">
                Email
              </label>
            ...
            {/* Password */}
            <div className="space-y-1.5">
              <label htmlFor="signin-password" className="block text-[13px] leading-[16px] font-medium text-text-primary">
                Password
              </label>
              <div className="relative">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-text-muted text-[18px]">
